...
const mySecret = 'superSecretKeyNotToShareWithAny1YouReadMeWell! 😁';
endpoints.use(session({secret: mySecret, resave: true, saveUninitialized: true, cookie: {maxAge: oneDay}}));
// endpoints.use(cookieParser(mySecret));
